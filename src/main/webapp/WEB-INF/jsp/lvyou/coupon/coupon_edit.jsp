...
<body>
	<form action="coupon/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">限期:</td>
				<td><input class="span10 date-picker" name="DEADLINE" id="DEADLINE" value="${pd.DEADLINE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="限期" title="限期"/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">描述:</td>
				<td><input type="text" name="DES" id="DES" value="${pd.DES}" maxlength="32" placeholder="这里输入描述" title="描述"/></td>
			</tr>
			<tr>
