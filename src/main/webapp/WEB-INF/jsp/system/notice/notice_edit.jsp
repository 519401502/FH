	...
	<form action="notice/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><textarea type="text" name="NOTICE_CONTENT" id="NOTICE_CONTENT"  maxlength="500" placeholder="这里输入公告内容" title="公告内容" rows="8" cols="20">${pd.NOTICE_CONTENT}</textarea></td>
			</tr>
			<tr>
