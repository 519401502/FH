package com.fh.controller.system.useraddress;
...
public class UserAddressController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, "新增UserAddress");
	...
	public void delete(PrintWriter out){
		logBefore(logger, "删除UserAddress");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, "修改UserAddress");
	...
	public ModelAndView list(Page page){
		logBefore(logger, "列表UserAddress");
		...
		try{
			...
			mv.setViewName("system/useraddress/useraddress_list");
	...
	public ModelAndView goAdd(){
		logBefore(logger, "去新增UserAddress页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("system/useraddress/useraddress_edit");
	...
	public ModelAndView goEdit(){
		logBefore(logger, "去修改UserAddress页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public Object deleteAll() {
		logBefore(logger, "批量删除UserAddress");
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出UserAddress到excel");
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var3", varOList.get(i).getString("USER_ADDRESS"));	//3
