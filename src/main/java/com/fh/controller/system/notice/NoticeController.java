package com.fh.controller.system.notice;
...
public class NoticeController extends BaseController {
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("CREATETIME", Tools.date2Str(new Date()));	//建立日期
		pd.put("CTYPE", 0);	//公告类型
	...
	public ModelAndView exportExcel(){
		logBefore(logger, "导出Notice到excel");
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var1", varOList.get(i).getString("NOTICE_CONTENT"));	//1
