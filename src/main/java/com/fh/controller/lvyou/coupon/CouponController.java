package com.fh.controller.lvyou.coupon;
...
import com.fh.service.lvyou.coupon.CouponService;
...
public class CouponController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("lvyou/coupon/coupon_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("lvyou/coupon/coupon_edit");
	...
	public ModelAndView exportExcel(){
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var1", varOList.get(i).get("MONEY").toString());	//1
				vpd.put("var2", varOList.get(i).getString("DEADLINE"));	//2
				vpd.put("var3", varOList.get(i).getString("DES"));	//3
				varList.add(vpd);
			}
