package com.fh.controller.lvyou.news;
...
import com.fh.service.lvyou.news.NewsService;
...
public class NewsController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("lvyou/news/news_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("lvyou/news/news_edit");
