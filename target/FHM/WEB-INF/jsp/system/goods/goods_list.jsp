						...
						<c:forEach items="${varList}" var="var" varStatus="vs">
							<tr>
								...
								<td class='center' style="width: 30px;">${vs.index+1}</td>
										<td>${var.GNAME}</td>
										<td>${var.GPRICE}</td>
										<td>${var.GNOW_PRICE}</td>
										<td>${var.GPIC_SALE}</td>
										<td>
											<c:if test="${var.GPIC_PATH != null && var.GPIC_PATH != ''}">
												<a href="<%=basePath%>uploadFiles/uploadImgs/${var.GPIC_PATH}" target="_blank"><img
														src="<%=basePath%>uploadFiles/uploadImgs/${var.GPIC_PATH}" width="210"/></a>
											</c:if>
										</td>
